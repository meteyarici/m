...
use Webkul\Shop\Http\Controllers\API\BidController;
...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::group(['middleware' => ['customer'], 'prefix' => 'auction'], function () {

        Route::controller(BidController::class)->prefix('bid')->group(function () {
            Route::post('', 'make')->name('shop.api.auction.bid.make');
        });
