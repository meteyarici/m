...
Route::prefix('customer')->group(function () {
    ...
    Route::get('create-auction', [HomeController::class, 'createAuction'])
        ->name('shop.create-auction.index');

    Route::post('upload-images', [\App\Http\Controllers\AuctionController::class, 'upload'])
        ->name('shop.auction.upload');

    Route::post('auction/store', [\App\Http\Controllers\AuctionController::class, 'store'])
        ->name('shop.auction.store');
