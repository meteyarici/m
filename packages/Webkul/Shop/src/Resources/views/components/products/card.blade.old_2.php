<div
    class="1180:transtion-all group w-full rounded-sm 1180:relative 1180:grid 1180:content-start 1180:overflow-hidden 1180:duration-300 1180:hover:shadow-[0_5px_10px_rgba(0,0,0,0.1)]"
    v-if="mode != 'list'"
>
    <div class="relative max-h-[300px] max-w-[291px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-sm max-sm:max-h-[200px] max-sm:max-w-full">
        ...
        <div class="action-items bg-black">
            ...
            <div class="opacity-0 transition-all duration-300 group-hover:bottom-0 group-hover:opacity-100 max-lg:opacity-100 max-sm:opacity-100">
                ...
                <span
                    class="absolute top-2.5 flex h-6 w-6 items-center justify-center rounded-sm border border-zinc-200 bg-white text-lg md:hidden ltr:right-1.5 rtl:left-1.5"
                    role="button"
                ...
                <span
                    class="icon-compare absolute top-10 flex h-6 w-6 items-center justify-center rounded-sm border border-zinc-200 bg-white text-lg sm:hidden ltr:right-1.5 rtl:left-1.5"
                    role="button"
    ...
    <div class="-mt-9 grid max-w-[291px] translate-y-9 content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:translate-y-0 max-md:gap-0 max-md:px-0 max-md:py-1.5 max-sm:min-w-[170px] max-sm:max-w-[192px]">
        ...
        <div class="flex w-full justify-between ">
            ...
            <div class="text-xs opacity-80">179 gün, 9 s, 7 d, 31 s</div>
        </div>
        ...
        <div class="action-items flex items-center justify-between opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 max-md:hidden">
            ...
            <button
                class="secondary-button w-full max-w-full p-2.5 text-sm font-medium max-sm:rounded-sm max-sm:p-2"
