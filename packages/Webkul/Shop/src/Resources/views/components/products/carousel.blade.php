...
@pushOnce('scripts')
    ...
    >
        <div
            class="container mt-4 max-lg:px-8 max-md:mt-8 max-sm:mt-7 max-sm:!px-4"
            v-if="! isLoading && products.length"
        >
            <div class="flex justify-between">
                <h2 class="text-xl max-md:text-2xl max-sm:text-xl  flex justify-left">

                  <span class="mt-1 ">  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <template v-if="products.length > 3">
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"   tabindex="0"   role="button" @click="swipeLeft">
                            <path d="M15 19L8 12L15 5" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"   tabindex="0"  role="button" @click="swipeRight">
            ...
            <div
                ref="swiperContainer"
                class="flex gap-4 pb-2.5 [&>*]:flex-[0] mt-4 overflow-auto scroll-smooth scrollbar-hide max-md:gap-7 max-md:mt-5 max-sm:gap-4 max-md:pb-0 max-md:whitespace-nowrap"
            >
