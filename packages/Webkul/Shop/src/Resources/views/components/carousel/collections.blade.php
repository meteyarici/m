...
<v-carousel-collections :images="{{ json_encode($options['images'] ?? []) }}">
    <div class="overflow-hidden">
        <div class="shimmer aspect-[2.743/1] max-h-screen w-screen"></div>
    </div>
</v-carousel-collections>

@pushOnce('scripts')
    <script
        type="text/x-template"
        id="v-carousel-collections-template"
    >
    ...
    <script type="module">
        app.component("v-carousel-collections", {
            template: '#v-carousel-collections-template',
